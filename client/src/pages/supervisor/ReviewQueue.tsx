                    ...
                    <td>
                      {s.ai_status === 'done' ? (
                        <div className="row" style={{ gap: 6 }}>
                          <span className="badge badge-brand" title="Grammar">G {Number(s.ai_grammar_score).toFixed(1)}</span>
                          <span className="badge badge-brand" title="Quality">Q {Number(s.ai_quality_score).toFixed(1)}</span>
                        </div>
                      ) : s.ai_status === 'failed' ? (
                        <span className="tiny" style={{ color: 'var(--danger, #c0392b)' }}>AI check failed</span>
                      ) : (
                        <span className="tiny">Scoring…</span>
                      )}
                    </td>
